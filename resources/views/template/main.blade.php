...
<head>
  ...
  {{-- HRS MENYERTAKAN {{ asset(namaFolderTemplate)}} BIAR BISA PAKE TEMPLATENYA --}}
...
<body>
                ...
                <li>
                  <div class="message-notif-scroll scrollbar-outer">
                    <div class="notif-center">
                      <a href="#">
                        <div class="notif-img"> 
                          <img src="{{ asset('vendor') }}/examples/assets/img/jm_denis.jpg" alt="Img Profile">
                        </div>
                      ...
                      <a href="#">
                        <div class="notif-img"> 
                          <img src="{{ asset('vendor') }}/examples/assets/img/chadengle.jpg" alt="Img Profile">
                        </div>
                        <div class="notif-content">
                      ...
                      <a href="#">
                        <div class="notif-img"> 
                          <img src="{{ asset('vendor') }}/examples/assets/img/mlane.jpg" alt="Img Profile">
                        </div>
                        <div class="notif-content">
                      ...
                      <a href="#">
                        <div class="notif-img"> 
                          <img src="{{ asset('vendor') }}/examples/assets/img/talha.jpg" alt="Img Profile">
                        </div>
                        <div class="notif-content">
                ...
                <li>
                  <div class="notif-scroll scrollbar-outer">
                    <div class="notif-center">
                      ...
                      <a href="#">
                        <div class="notif-img"> 
                          <img src="{{ asset('vendor') }}/examples/assets/img/profile2.jpg" alt="Img Profile">
                        </div>
                        <div class="notif-content">
                          <span class="block">
                ...
                <ul class="nav nav-collapse">
                  <li>
                    <a href="{{ route('costumer')}}">
                      <span class="sub-item">Costumer</span>
                    </a>
                  </li>                  
                </ul>
            </div>
  ...
  <!-- Bootstrap Notify -->
  <script src="{{ asset('vendor') }}/examples/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
